...
<body>
    ...
    {{-- container --}}
    <div class=" dark:bg-slate-700 px-36 pt-[40px]">
        <div class="grid lg:grid-cols-3 min-[50px]:grid-cols-1 py-2px  gap-4">
            {{-- Form Input --}}
            <div
                class="block  pointer-events-none h-[25rem] p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800  ">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">1. Inputs</h5>
            ...
            {{-- Controller --}}
            <div
                class="block h-60 p-6 mb-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 align-middle">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">2. Controller</h5>
                <div class="bg-black rounded-lg shadow text-white m-4 dark:bg-gray-800">
                    tes
                </div>
            </div>
            {{-- Result --}}
            <div 
                class="block   h-[25rem] p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800  ">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">3. Result</h5>
                <div class="bg-black rounded-lg shadow text-white m-4 dark:bg-gray-800">
                    tes
                </div>
